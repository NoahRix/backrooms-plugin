...
public class BlueMapHook {
    ...
    public BlueMapHook(BackroomsPlugin plugin) {
        this.plugin = plugin;
    }

    public void register() {
        if (!plugin.getBackroomsConfig().isBlueMapEnabled()) return;
    ...
    private void initializeMarkerSets() {
        ...
        if (plugin.getBackroomsConfig().isBlueMapMarkers()) {
            MarkerSet specialRooms = MarkerSet.builder()
                    ...
                    .sorting(0)
                    .build();
            markerSets.put("backrooms:special-rooms", specialRooms);
            ...
            MarkerSet hazards = MarkerSet.builder()
                    ...
                    .sorting(1)
                    .build();
            markerSets.put("backrooms:hazards", hazards);
            ...
            MarkerSet stairwells = MarkerSet.builder()
                    ...
                    .sorting(2)
                    .build();
            markerSets.put("backrooms:stairwells", stairwells);
            ...
            MarkerSet loot = MarkerSet.builder()
                    ...
                    .sorting(3)
                    .build();
            markerSets.put("backrooms:loot", loot);
        }

        if (plugin.getBackroomsConfig().isBlueMapOverlays()) {
            MarkerSet overlays = MarkerSet.builder()
                    ...
                    .sorting(4)
                    .build();
            markerSets.put("backrooms:level-zones", overlays);
        }
    }
    ...
    private void registerMarkersOnMaps(BlueMapAPI api) {
        ...
        if (bmWorld.isEmpty()) {
            plugin.getLogger().warning("BlueMap: Backrooms world '" + worldName + "' not found in BlueMap");
            return;
        }
    ...
    private void addLevelZoneOverlays(BlueMapWorld world) {
        MarkerSet overlays = markerSets.get("backrooms:level-zones");
    ...
    public void addSpecialRoomMarker(int x, int y, int z, String label, String detail) {
        MarkerSet set = markerSets.get("backrooms:special-rooms");
        if (set == null) return;
    ...
    public void addHazardMarker(int x, int y, int z, String hazardType) {
        MarkerSet set = markerSets.get("backrooms:hazards");
        if (set == null) return;
    ...
    public void addStairwellMarker(int x, int y, int z, String targetLevel) {
        MarkerSet set = markerSets.get("backrooms:stairwells");
        if (set == null) return;
    ...
    public void addLootMarker(int x, int y, int z) {
        MarkerSet set = markerSets.get("backrooms:loot");
        if (set == null) return;
    ...
    public void addLevelZoneOverlay(int x1, int z1, int x2, int z2, int y, String levelName, String levelId) {
        MarkerSet set = markerSets.get("backrooms:level-zones");
        if (set == null) return;
