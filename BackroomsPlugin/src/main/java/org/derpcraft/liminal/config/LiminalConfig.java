...
import org.derpcraft.liminal.generator.levels.GenericLiminalLevel;
import org.derpcraft.liminal.generator.levels.Level0Lobby;
import org.derpcraft.liminal.generator.levels.Level1HabitableZone;
import org.derpcraft.liminal.generator.levels.Level2PipeDreams;
 ...
 * the corresponding {@link LiminalLevel} subclasses ({@link Level0Lobby},
...
public class LiminalConfig {
     ...
     * </ul>
     *
     * <p>Unknown level IDs fall back to {@link GenericLiminalLevel} so new levels can
    ...
    /**
     * Creates the appropriate {@link LiminalLevel} subclass for the given config.
     *
    ...
    private LiminalLevel createLevelInstance(LevelConfig lc, long seed) {
        return switch (lc.getId()) {
            ...
            default -> new GenericLiminalLevel(lc, seed);
        };
    }
