...
/**
 * Abstract base class for all Backrooms levels.
 *
 * <p>Each Backrooms level occupies a vertical slice of the world defined by a Y-range
...
public abstract class BackroomsLevel {
     ...
     */
    protected BackroomsLevel(LevelConfig config, long seed) {
        this.config = config;
        this.seed = seed;
    }
     ...
     *
     * <p>This is the main entry point called by {@code BackroomsChunkGenerator}. It
