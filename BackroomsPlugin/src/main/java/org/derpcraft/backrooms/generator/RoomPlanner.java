...
/**
 * Plans room layouts for the Backrooms world using a deterministic grid-based approach.
 *
...
public class RoomPlanner {
    ...
    /**
     * Enumeration of special room types that can appear in the Backrooms.
     */
    ...
    /**
     * Immutable data class describing a single room in the Backrooms grid.
     *
