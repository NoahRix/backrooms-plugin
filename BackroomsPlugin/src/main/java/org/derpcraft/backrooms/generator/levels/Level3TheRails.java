 ...
 * @see BackroomsLevel
 * @see Level0Lobby
 * @see GenericBackroomsLevel
 */
public class Level3TheRails extends BackroomsLevel {
    ...
    protected void generateLighting(ChunkGenerator.ChunkData chunkData,
        ...
        World world = null;
        if (plugin != null) {
            world = plugin.getServer().getWorld(plugin.getBackroomsConfig().getBackroomsWorldName());
        }
